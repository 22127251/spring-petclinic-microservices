        ...
        stage('Determine Build') {
            steps {
                script {
                    ...
                    env.CHANGED_FILES = bat(returnStdout: true, script: 'git diff --name-only HEAD^ HEAD').trim()
            ...
            steps {
                script {
                    if (env.SERVICES_TO_BUILD instanceof String && env.SERVICES_TO_BUILD != 'all') {
                        ...
                        bat "./mvnw -f ${env.SERVICES_TO_BUILD}/pom.xml test"
            ...
            steps {
                script {
                   if (env.SERVICES_TO_BUILD instanceof String && env.SERVICES_TO_BUILD != 'all') {
                        ...
                        bat "./mvnw -f ${env.SERVICES_TO_BUILD}/pom.xml org.jacoco:jacoco-maven-plugin:report"
                        recordCoverage(
            ...
            steps {
                script {
                    if (env.SERVICES_TO_BUILD instanceof String && env.SERVICES_TO_BUILD != 'all') {
                        ...
                        bat "./mvnw -f ${env.SERVICES_TO_BUILD}/pom.xml clean install -DskipTests"
